...
const LandingPage = () => {
    return (
        <div className="mb-12 flex flex-col gap-5 mt-5 w-full items-center">
            ...
            <Link to="/products" className="bg-discover  py-3 px-10 mx-auto flex items-center justify-center sm:text-2xl md:text-3xl font-lato font-bold text-white text-sm" >Discover</Link>
            </div>
        </div>
    )
}
